...
<template>
    ...
    <div class="min-h-screen bg-[#040d22] p-3 text-[#d8e7ff] sm:p-5">
        <div class="mx-auto max-w-7xl">
            ...
            >
                <div>
                    ...
                    <p class="mt-1 text-sm text-[#9dbcf0]">
                        Gestao das respostas capturadas nos funis.
                    </p>
                </div>
                <div class="grid grid-cols-2 items-center gap-2 sm:flex">
                    <a
                        :href="exportUrl"
                        class="rounded-lg border border-[#2e4f8a] bg-[#0d2a57] px-4 py-2 text-sm text-[#d8e7ff]"
                        >Exportar CSV</a
                    >
                    <Link
                        href="/dashboard"
            ...
            <section
                class="mb-4 grid gap-3 rounded-xl border border-[#20365f] bg-[#071733] p-4 md:grid-cols-4"
            >
                <input
                    v-model="filters.q"
                    type="text"
                    placeholder="Buscar por nome, email ou telefone"
                    class="rounded-lg border border-[#2e4f8a] bg-[#0a2147] px-3 py-2 text-sm text-white outline-none md:col-span-2"
                    @keyup.enter="applyFilters"
                />

                <select
                    v-model="filters.status"
                    class="rounded-lg border border-[#2e4f8a] bg-[#0a2147] px-3 py-2 text-sm text-white outline-none"
                >
                ...
                <div class="flex items-center gap-2 md:col-span-4">
                    <button
                        class="rounded-lg bg-gradient-to-r from-[#1d5fd2] to-[#3f8dff] px-4 py-2 text-sm font-semibold text-white"
                        @click="applyFilters"
                    >
                        Filtrar
                    </button>
            ...
            <section
                class="overflow-hidden rounded-xl border border-[#20365f] bg-[#071733]"
            >
                        ...
                        <tbody>
                            ...
                            >
                                <tr class="border-t border-[#1a3157]">
                                        ...
                                        <div class="flex items-start gap-2">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-1">
                                                    <Link
                                                        :href="`/leads/${lead.id}`"
                                                        class="text-[11px] text-[#7fb0ff] hover:text-white"
                                                        >Abrir detalhe</Link
                                                    >
                                                </div>
                                            </div>
                                    ...
                                    <td class="px-4 py-3">
                                        <p>
                                            {{ lead.lead_email || 'Sem email' }}
                                        </p>
                                        <p class="text-xs text-[#87a9e6]">
                                            {{
                                                lead.lead_phone ||
                                                'Sem telefone'
                                            }}
                                        ...
                                        <p
                                            class="mt-2 text-[11px] text-[#8fb0e6]"
                                        >
                                            Tags atuais:
                                            {{ formatTags(lead.tags) }}
                                        </p>
                                        <p
                                            class="mt-1 text-[11px] text-[#7092cc]"
                                        >
                                            Responsavel:
                                            {{
                                                lead.assignee.name ||
                                            ...
                                            <select
                                                v-model="
                                                    leadDrafts[lead.id]
                                                        .assignee_id
                                                "
                                                class="w-full rounded-md border border-[#2e4f8a] bg-[#0a2147] px-2 py-1.5 text-xs text-white outline-none"
                                            >
                                                <option :value="null">
                                                    Nao definido
                                                </option>
                                    ...
                                    <td class="px-4 py-3">
                                        <select
                                            ...
                                            class="rounded-md border border-[#2e4f8a] bg-[#0a2147] px-2 py-1 text-xs text-white outline-none"
                                        >
                                            <option
                                        ...
                                        <button
                                            class="mt-2 rounded-md border border-[#3d6cc0] bg-[#12386d] px-2 py-1 text-[11px] text-white"
                                ...
                                <tr
                                    ...
                                    class="border-t border-[#1a3157] bg-[#06142d]"
                                >
                                    <td colspan="5" class="px-4 py-4">
                                        <div class="grid gap-4 xl:grid-cols-2">
                                            <section
                                                class="rounded-xl border border-[#20365f] bg-[#071733] p-4"
                                            >
                                                <p
                                                ...
                                                >
                                                    <article
                                                        ...
                                                        :key="answer.id"
                                                        class="rounded-lg border border-[#1a3157] bg-[#0a2147] p-3"
                                                    >
                                                        <p
                            ...
                            <tr v-if="props.leads.data.length === 0">
                                <td
                                    colspan="5"
                                    class="px-4 py-8 text-center text-[#9ec0fa]"
                                >
